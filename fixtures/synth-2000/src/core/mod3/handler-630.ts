...
export interface Payload630 { id: string; value: number; tags?: string[] }

export class Handler630 {
  private cache = new Map<string, number>();
  async run(input: Payload630): Promise<number> {

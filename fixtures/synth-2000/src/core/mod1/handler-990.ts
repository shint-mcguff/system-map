...
export interface Payload990 { id: string; value: number; tags?: string[] }

export class Handler990 {
  private cache = new Map<string, number>();
  async run(input: Payload990): Promise<number> {

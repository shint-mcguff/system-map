...
export interface Payload720 { id: string; value: number; tags?: string[] }

export class Service720 {
  private cache = new Map<string, number>();
  async run(input: Payload720): Promise<number> {

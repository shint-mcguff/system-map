...
export interface Payload870 { id: string; value: number; tags?: string[] }

export class Handler870 {
  private cache = new Map<string, number>();
  async run(input: Payload870): Promise<number> {

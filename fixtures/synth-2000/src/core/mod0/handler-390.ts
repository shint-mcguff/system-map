...
export interface Payload390 { id: string; value: number; tags?: string[] }

export class Handler390 {
  private cache = new Map<string, number>();
  async run(input: Payload390): Promise<number> {

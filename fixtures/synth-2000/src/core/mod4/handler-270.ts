...
export interface Payload270 { id: string; value: number; tags?: string[] }

export class Handler270 {
  private cache = new Map<string, number>();
  async run(input: Payload270): Promise<number> {

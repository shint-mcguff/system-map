...
export interface Payload1386 { id: string; value: number; tags?: string[] }

export class Model1386 {
  private cache = new Map<string, number>();
  async run(input: Payload1386): Promise<number> {

...
export interface Payload966 { id: string; value: number; tags?: string[] }

export class Handler966 {
  private cache = new Map<string, number>();
  async run(input: Payload966): Promise<number> {

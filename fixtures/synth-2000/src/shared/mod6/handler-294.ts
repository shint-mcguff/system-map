...
export interface Payload294 { id: string; value: number; tags?: string[] }

export class Handler294 {
  private cache = new Map<string, number>();
  async run(input: Payload294): Promise<number> {

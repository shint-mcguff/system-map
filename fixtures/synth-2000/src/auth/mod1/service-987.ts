...
export interface Payload987 { id: string; value: number; tags?: string[] }

export class Service987 {
  private cache = new Map<string, number>();
  async run(input: Payload987): Promise<number> {

...
export interface Payload555 { id: string; value: number; tags?: string[] }

export class Service555 {
  private cache = new Map<string, number>();
  async run(input: Payload555): Promise<number> {

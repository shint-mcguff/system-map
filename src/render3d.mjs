...
<div id="results"></div>
<span class="hint">drag:移動 · wheel:ズーム · 右drag:回転 · click:詳細 · dbl-click:リセット</span>
</header>
<div id="stage"></div>
<div id="panel"></div>
...
// ---- カメラ操作（Google Maps式: ドラッグ=パン、右/Ctrl+ドラッグ=回転）----
...
cv.addEventListener('pointermove',function(e){
  ...
  moved=true;
  if(drag.rotate){
    // 回転: 右ドラッグ/Ctrl+ドラッグのみ
    yaw+=dx*0.006;pitch=Math.max(0.12,Math.min(1.45,pitch+dy*0.005));
  } else {
    // パン: 画面の動きにそのまま追従
